...
from src.config.units import ProjectUnits, convert_from_feet
...
PLATE_CONFIGS = {
    ...
    ("bottom", 2): [
        # Bottom plate
        PlateConfig(
            structural_multiplier=0.5,
            schematic_multiplier=-0.5,
            reference="base"
        ),
        # Sole plate
        PlateConfig(
            structural_multiplier=1.5,
            schematic_multiplier=-1.5,
            reference="base"
        ),
    ],
...
def calculate_plate_offset(
    ...
    multiplier = (plate_config.structural_multiplier 
