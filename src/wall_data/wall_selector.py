...
def pick_walls_from_active_view():
    ...
    try:
        ...
        references = uidoc.Selection.PickObjects(ObjectType.Element, WallSelectionFilter(), "Select walls in the active view")
    ...
    for ref in references:
        ...
        if element and element.Category and element.Category.Id.IntegerValue == int(BuiltInCategory.OST_Walls):
