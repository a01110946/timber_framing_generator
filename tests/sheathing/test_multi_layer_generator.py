...
# =============================================================================
# Note: TestFlipNormalization was removed — _normalize_flip is no longer used.
# The Wall Analyzer now sets z_axis directly from Revit's wall.Orientation,
# which is the geometric exterior normal and does NOT change when the wall
# is flipped.  No downstream flip correction is needed.
# =============================================================================
